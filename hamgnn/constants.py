...
RESULTS_P_PARAM_GENERALIZATION_PLOT_HAM_PROBABILITY = [
    max(DEFAULT_HAMILTONIAN_PROBABILITY - 0.2, DEFAULT_HAMILTONIAN_PROBABILITY / 2),
...
MODEL_CHECKPOINT_SAVING_DIRECTORY = Path(config["LOGGING"]["CHECKPOINT_STORAGE_DIRECTORY"])
MAIN_MODEL_CHECKPOINT_PATH = MODEL_CHECKPOINT_SAVING_DIRECTORY / "MAIN_MODEL.ckpt"
ABLATION_NO_RANDOM_FEATURES_PATH = MODEL_CHECKPOINT_SAVING_DIRECTORY / "ablation_no_random_features.ckpt"
ABLATION_NO_PERSISTENT_FEATURES_PATH = MODEL_CHECKPOINT_SAVING_DIRECTORY / "ablation_no_persistent_features.ckpt"
ABLATION_MAIN_MODEL_PATH = MODEL_CHECKPOINT_SAVING_DIRECTORY / "ablation_main_model.ckpt"
